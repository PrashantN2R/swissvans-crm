...
@section('title', 'Welcome to Hyper | Innovative IT Solutions | Software Development | Cloud & Cybersecurity Services')
@section('og-title', 'Welcome to Hyper | Innovative IT Solutions | Software Development | Cloud & Cybersecurity
    Services')
@section('meta-desc', 'At Hyper, we deliver cutting-edge IT solutions including software development, cloud services,
    cybersecurity, and IT consulting to drive business growth.')
@section('og-desc', 'At Hyper, we deliver cutting-edge IT solutions including software development, cloud services,
    cybersecurity, and IT consulting to drive business growth.')
@section('og-type', 'website')
@section('meta-keywords', 'IT services, software development, cloud solutions, cybersecurity, IT consulting, mobile app
    development, enterprise solutions, AI solutions, Hyper IT company, technology solutions, digital transformation, managed
    IT services')
@section('content')
            ...
            <div class="row align-items-center">
                <div class="col-md-5">
                    <div class="mt-md-4">
                        ...
                        <p class="mb-3 font-16 text-white-50">Hyper is a fully featured dashboard and admin template
                            comes with tones of well designed UI elements, components, widgets and pages.</p>

                        <a href="{{ route('register') }}" target="_blank" class="btn btn-success">Get Started <i
