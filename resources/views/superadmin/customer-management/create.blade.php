...
@section('title', 'Add Customer | Superadmin')
@section('head')
            ...
            <div class="col-12">
                <div class="page-title-box">
                    ...
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('superadmin.users.index') }}">Customers</a></li>
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    @endif
                                    <img id="preview_img" src="https://placehold.co/150x150/E3E1FF/7272DC?text=Customer"
