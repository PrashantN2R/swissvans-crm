...
@section('title', 'Users | Superadmin')
@section('head')
            ...
            <div class="col-12">
                <div class="page-title-box">
                    <div class="page-title-right">
                        ...
                        <a href="{{ route('superadmin.users.create') }}" class="btn btn-sm btn-primary"><i
            ...
            <div class="col-12">
                ...
                <div class="row">
                    <div class="col-md-12 col-lg-12 col-xl-12 col-xxl-12">
                        <div class="card">
                            <div class="card-body">
                                <form class="row g-2" action="{{ route('superadmin.users.index') }}">
                                    <div class="col-md-3">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @foreach ($user->roles as $role)
                                                @switch($role->name)
                                                    @case('Administrator')
                                                        <span class="btn btn-xs btn-primary w-100">{{ $role->name }}</span>
                                                    @break

                                                    @case('Manager')
                                                        <span class="btn btn-xs btn-success w-100">{{ $role->name }}</span>
                                                    @break

                                                    @default
                                                        <span class="btn btn-xs btn-pink w-100">{{ $role->name }}</span>
                                                @endswitch
                                            @endforeach
                                        </td>
                                        <td>
                                        ...
                                        <td class="text-end">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-end">
                                                ...
                                                <a href="{{ route('superadmin.users.show', $user->slug) }}"
                                                    ...
                                                    View
                                                    User</a>
                                                <a href="{{ route('superadmin.users.edit', $user->slug) }}"
...
@push('scripts')
    ...
    <script type="text/javascript">
        ...
        $("#delete-all").click(function(e) {
            rows = [], $("input:checkbox[name=rows]:checked").each(function() {
                ...
                t.isConfirmed && ($("#delete-all").text("Deleting..."), e.preventDefault(), $.ajax({
                    type: "POST",
                    dataType: "json",
                    url: "{{ route('superadmin.users.bulk-delete') }}",
                    data: {
                        users: rows,
                        _token: "{{ csrf_token() }}"
                    },
        ...
        $(".status").change(function() {
            var url = "{{ route('superadmin.users.change-status', ':id') }}";
