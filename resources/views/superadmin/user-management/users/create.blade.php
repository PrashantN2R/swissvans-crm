...
@section('title', 'Create User | Superadmin')
@section('head')
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                ...
                <form id="superadminForm" method="POST" action="{{ route('superadmin.users.store') }}"
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-lg-6 mb-2 {{ $errors->has('password') ? 'has-error' : '' }}">
                                ...
                                <div class="col-lg-6 mb-2 {{ $errors->has('password_confirmation') ? 'has-error' : '' }}">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    @endif
                                    <img id="preview_img" src="https://placehold.co/150x150/E3E1FF/7272DC?text=User"
                                    ...
                                    <div class="form-group col-md-12">
                                        <select id="role" class="form-select @error('role') is-invalid @enderror"
                                            ...
                                            @foreach ($roles as $id => $name)
                                                <option value="{{ $name }}"
                                                    {{ in_array($name, old('role') ? (array) old('role') : []) ? 'selected' : '' }}>
                                                    {{ $name }}</option>
                                            @endforeach
                                        </select>
                                        @error('role')
