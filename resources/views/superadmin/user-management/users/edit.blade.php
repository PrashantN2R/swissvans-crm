    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                ...
                <form id="superadminForm" method="POST" action="{{ route('superadmin.users.update', $user->id) }}"
                                    ...
                                    <div class="form-group col-md-12">
                                        <select id="role" class="form-select @error('role') is-invalid @enderror"
                                            ...
                                            @foreach ($roles as $id => $name)
                                                <option value="{{ $name }}"
                                                    {{ in_array($name, old('role') ? (array) old('role') : $user->roles->pluck('name')->toArray()) ? 'selected' : '' }}>
                                                    {{ $name }}</option>
                                            @endforeach
                                        </select>
                                        @error('role')
