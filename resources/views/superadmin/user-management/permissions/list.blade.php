...
@section('title', 'Permissions | Superadmin')
@section('head')
            ...
            <div class="col-12">
                <div class="page-title-box">
                    <div class="page-title-right">
                        ...
                        <a href="{{ route('superadmin.permissions.create') }}" class="btn btn-sm btn-primary"><i
            ...
            <div class="col-12">
                ...
                <div class="row">
                    <div class="col-md-12 col-lg-12 col-xl-12 col-xxl-12">
                        <div class="card">
                            <div class="card-body">
                                <form class="row g-2" action="{{ route('superadmin.permissions.index') }}">
                                    <div class="col-md-10">
                                        <label for="name" class="form-label">Permission</label>
                                        <input type="text" class="form-control form-control-sm"
                                            placeholder="Search by permission" name="name" id="name"
                                            value="{{ $filter['name'] }}">
                                    </div>
                ...
                <div class="row">
                    <div class="col-md-12 col-lg-12 col-xl-12 col-xxl-12 mb-md-5 mb-xl-5">
                        <table id="basic-datatable"
                            ...
                            <thead>
                                <tr>
                                    <th class="th-primary" width="40%">Permission</th>
                                    <th class="th-primary" width="40%">Role</th>
                                    ...
                                    <tr>
                                        <td class="table-user">
                                            <a href="{{ route('superadmin.permissions.show', $permission->id) }}"
                                                class="text-body fw-semibold">{{ $permission->name }}</a>
                                        </td>

                                        <td>
                                            @foreach ($permission->roles as $role)
                                                <span class="badge badge-dark-lighten mx-1 my-1">{{ $role->name }}</span>
                                            @endforeach
                                        </td>
                                        <td>
                                            <i class="uil-calender me-1"></i>
                                            {{ \Carbon\Carbon::parse($permission->created_at)->format('M d Y') }}<br>
                                            <i class="uil-clock me-1"></i>
                                            {{ \Carbon\Carbon::parse($permission->created_at)->format('h:i A') }}
                                        </td>
                                        <td class="text-end">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-end">
                                                ...
                                                <a href="javascript:void(0);"
                                                    onclick="confirmDelete({{ $permission->id }})" class="dropdown-item"><i
                                                        class="uil-trash-alt me-1"></i>
                                                    Delete
                                                    Permission</a>
                                                <form id='delete-form{{ $role->id }}'
                                                    action='{{ route('superadmin.permissions.destroy', $permission->id) }}'
                                                    method='POST'>
