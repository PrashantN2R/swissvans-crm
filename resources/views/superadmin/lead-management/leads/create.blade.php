...
@section('title', 'Create Lead | Superadmin')
@section('head')
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                ...
                <form id="leadForm" method="POST" action="{{ route('superadmin.leads.store') }}"
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4 mb-2 {{ $errors->has('event_type') ? 'has-error' : '' }}">
                                    ...
                                    <input type="text" class="form-control" id="event_type" name="event_type"
                                        placeholder="Enter Event Type" value="{{ old('event_type') }}">
                                    @error('event_type')
                                ...
                                <div class="col-lg-4 mb-2 {{ $errors->has('event_date') ? 'has-error' : '' }}">
                                    ...
                                    <input type="date" class="form-control" id="event_date" name="event_date"
                                        placeholder="Enter Event Date" value="{{ old('event_date') }}">
                                    @error('event_date')
                                ...
                                <div class="col-lg-4 mb-2 {{ $errors->has('budget') ? 'has-error' : '' }}">
                                    ...
                                    <input type="number" class="form-control" id="budget" name="budget"
                                        placeholder="Enter Budget" value="{{ old('budget', 0) }}">
                                    @error('budget')
                                ...
                                <div class="col-lg-4 mb-2 {{ $errors->has('source') ? 'has-error' : '' }}">
                                    ...
                                    <select class="form-select" name="source" id="source">
                                        ...
                                        <option value="crm" {{ old('source') == 'crm' ? 'selected' : '' }}>CRM</option>
